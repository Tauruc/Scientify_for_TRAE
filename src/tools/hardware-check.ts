...
export async function getOptimalExperimentConfig(hardware: HardwareInfo): Promise<ExperimentConfig> {
...
export async function generateHardwareReport(hardware: HardwareInfo, config: ExperimentConfig): Promise<string> {
